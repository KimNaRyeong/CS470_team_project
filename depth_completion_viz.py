...
if __name__ == "__main__":
  ...
  #model_path = "../models/gp-epoch=37-loss_val=-58.8280.ckpt"
  # base line
  ...
  rgb_path = "../dataset/examples/frame-01420.color.jpg"
  depth_path = "../dataset/examples/frame-01420.depth.pgm"
